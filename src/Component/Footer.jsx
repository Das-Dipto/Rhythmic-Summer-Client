    ...
    <footer aria-label="Site Footer" className="bg-gray-900">
      ...
      >
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            <div className="">
               <Link to='/' className="text-4xl flex items-center special-color" title='Toys of Automotive'>
                  <img src={MainLogo} className='w-[30px]' alt="logo" />    
                  <h2 className='text-teal-300 font-semibold'>Rhythmic</h2>
               </Link>
            </div>
          ...
          >
            ...
            <div>
              <p className="font-medium  text-teal-300">Company</p>
            ...
            <div>
              <p className="font-medium  text-teal-300">Helpful Links</p>
                ...
                <ul className="space-y-4 text-sm">
                  ...
                  <li>
                    <a
                      ...
                      className=" transition hover:opacity-75 text-gray-200 flex items-center"
                    >
                     <AiOutlineMail className='me-1' style={{fontSize:'18'}}/>rhythmic@summer.com
                  ...
                  <li>
                    <a
                      ...
                      className=" transition hover:opacity-75 text-gray-200 flex items-center"
                    >
                     <BiPhone className='me-1' style={{fontSize:'18'}}/> 247-3815-4610
                    </a>
                  </li>
                  <li>
                    <a
                    ...
                    >
                     <ImOffice className='me-1' style={{fontSize:'24'}}/> 1111 Old Summerville rd,
                     Brooklyn, NY, USA
                    </a>
                  </li>
                </ul>
            ...
            <div>
              <p className="font-medium  text-teal-300">Legal</p>
        ...
        <p className="text-xs special-color">
          &copy; Rhythmic(2023). All rights reserved.
        </p>
      </div>
    </footer>
  )
